...
if __name__=='__main__':
    ...
    try:
        while True:
            receive = input("Movement input: ")
            if receive == "w":
                PWM.set_motor_model(4060,4060,4060,4060)   #Forward
            elif receive == "s":
                PWM.set_motor_model(-2000,-2000,-2000,-2000)   #Back
            elif receive == "a":
                PWM.set_motor_model(-4060,-4060,4060,4060)
                time.sleep(.1)   #Left 
                PWM.set_motor_model(0,0,0,0)
            elif receive == "d":
                PWM.set_motor_model(4060,4060,-4060,-4060)     #Right    
            elif receive == "q":
                PWM.set_motor_model(0,0,0,0)
                break
            else:
